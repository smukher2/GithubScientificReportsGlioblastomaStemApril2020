---
title: "script2_Merging_Treatment_PGBCbyQGBC_v1"
...
#Checklist for this pipeline 
  ...
  #2) metadata file made by manually combining individual metadata files from GEO to give '(original)merge_GSE93991_metadata_edit_v3' which was further edited manually to give '(manual)merge_GSE93991_metadata_edit_v3_PGBCbyQGBC.csv' 
...
```{r}
merge_metadata=read.csv('./InputMetadata&Lists/(manual)merge_GSE93991_metadata_edit_v3_PGBCbyQGBC.csv', header =T, sep=',')
