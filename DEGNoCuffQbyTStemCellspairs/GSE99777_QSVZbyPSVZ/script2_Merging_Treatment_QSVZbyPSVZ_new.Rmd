---
title: "script2_Merging_Treatment_QSVZbyPSVZ"
...
#Checklist for this pipeline 
  ...
  #2) metadata file made by manually combining individual metadata files from GEO to give '(original)merge_GSE99777_metadata_edit_v4' which was further edited manually to give '(manual)merge_GSE99777_metadata_edit_v3_QSVZbyPSVZ.csv' 
...
```{r}
merge_metadata=read.csv('./InputMetadata&Lists/(manual)merge_GSE99777_metadata_edit_v3_QSVZbyPSVZ.csv', header =T, sep=',')
...
#mergeExpr_3=mergeExpr_3[!mergeExpr_3$M_PSVZ_GSM2652126 == "Inf", ]
